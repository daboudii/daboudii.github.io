...
for (e = "2.77.0", t = {}, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s = 0; s < i.length; s++)
  t[i.charCodeAt(s)] = s;
var e;
var t;
var i;
...
var On = { amd: function(e, { accessedGlobals: t, dependencies: i, exports: s, hasExports: n2, id: r2, indent: a2, intro: o2, isEntryFacade: l2, isModuleFacade: h2, namedExportsMode: c2, outro: u2, snippets: d2, warn: p2 }, { amd: f2, esModule: m2, externalLiveBindings: g2, freeze: y2, interop: x2, namespaceToStringTag: E2, strict: b2 }) {
  ...
  const T2 = b2 ? `${r2}'use strict';${k2}` : "", O2 = xn(i, y2, m2, f2, E2, t, r2, h2);
  e.prepend(`${a2}${O2}`);
  let R2 = `(${A2($2, { isAsync: false, name: null })}{${k2}${T2}${k2}`;
  n2 && (!x2 || p2 && o2 || (R2 = (w2 ? `${S2} ${x2}` : `this${Sn(x2, I2)}`) + `${v2}=${v2}${R2}`), P2 && (R2 = function(e2, t2, i2, { _: s2, getPropertyAccess: n3, s: r3 }, a3) {
    const o3 = e2.split(".");
  ...
  const D2 = pn(s, i, o2, y2, h2, r2, m2);
  ...
  return async function(e2, t) {
    const { options: i, unsetOptions: s } = await async function(e3, t2) {
      ...
      const i2 = pl(e3.plugins), { options: s2, unsetOptions: n3 } = function(e4) {
        ...
        return async (t3, i3) => i3.options && await i3.options.call({ meta: { rollupVersion: "2.77.0", watchMode: e4 } }, await t3) || t3;
...
*/
//# sourceMappingURL=chunk-DPJOTF3N.js.map
